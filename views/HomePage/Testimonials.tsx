...
const TESTIMONIALS = [
  {
    ...
    content: `Très bien. Je suis tellement satisfait de ce produit. Je n'ai même pas eu besoin de formation.`,
    author: {
      name: 'Kagro valery',
      title: 'Homme très sérieux',
      avatarUrl: '/testimonials/author-photo-1.jpeg',
    },
  },
  {
    companyLogoUrl: '/testimonials/company-logo-2.svg',
    content: `C'est vraiment merveilleux. J'utilise souvent honraconsulting. Merci! honraconsulting a vraiment aidé notre entreprise.`,
    author: {
      name: 'YAM-KING',
      title: `Diplômé de l'université masculine Sigma`,
