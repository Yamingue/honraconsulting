  ...
  return (
    <Wrapper>
      <Form onSubmit={handleSubmit(onSubmit)}>
        ...
        <InputGroup>
          <InputStack>
            {errors.name && <ErrorMessage>Ce champ est obligatoire</ErrorMessage>}
            <Input placeholder="Nom complet" id="name" disabled={isDisabled} {...register('name', { required: false })} />
          </InputStack>
          <InputStack>
            {errors.email && <ErrorMessage>Ce champ est obligatoire</ErrorMessage>}
            <Input placeholder="Email ou téléphone" id="email" disabled={isDisabled} {...register('email', { required: true })} />
          </InputStack>
        </InputGroup>
        <InputStack>
          {errors.description && <ErrorMessage>La description est obligatoire</ErrorMessage>}
          <Textarea
            as="textarea"
